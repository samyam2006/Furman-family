...
'''
    ...
    <section class="hero" aria-label="Introduction">
      <div class="hero__watermark" aria-hidden="true">Family Law</div>
      <div class="container">
        <div class="hero__grid">
          <div class="hero__copy">
            <p class="overline"><span class="tick"></span> Family Law — Columbia, Maryland</p>
            <h1 class="h-hero display lines" style="margin-top: 1.3rem;">
              <span class="ln"><span>Trusted Counsel.</span></span>
              <span class="ln"><span class="serif-italic">Exceptional</span></span>
              <span class="ln"><span class="serif-italic">Representation.</span></span>
            </h1>
            <p class="lead" data-reveal data-delay="2" style="margin-top: 1.6rem; max-width: 42ch;">
          ...
          <div class="hero__figure" data-reveal data-delay="2">
            {portrait("ar-tall", "Attorney / office photo — real image pending", parallax=True)}
            <div class="hero__badge">
              <div class="b-k">The boutique difference</div>
              <div class="b-v">You work directly with Angela — start to finish.</div>
            </div>
          </div>
        </div>
      </div>
      <div class="trust">
        <div class="container">
          <div class="trust__row" data-stagger>
